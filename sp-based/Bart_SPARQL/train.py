...
def train(args):
    ...
    model.zero_grad()
    for _ in range(epochs_trained, int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_loader):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                model.zero_grad()
                global_step += 1
            # if args.logger_steps > 0 and global_step % args.logger_steps == 0:
            #     logger.info("===================Dev==================")
            #     evaluate(args, model, val_loader, device)
            #     logger.info("===================Test==================")
...
def main():
    ...
    parser.add_argument('--logger_steps', default=448, type = int)
